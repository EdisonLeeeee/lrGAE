...
parser.add_argument('--alpha', type=float, default=0.001, help='loss weight for degree prediction. (default: 0.)')
...
def main():
    ...
    model = MaskGAE(encoder, decoder, mask, degree_decoder=degree_decoder).to(device)
    print(model)
    print(mask)
