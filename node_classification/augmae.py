...
from lrgae.masks import MaskFeature, NullMask, AdversMask
...
def main():
    ...
    model = AUGMAE(encoder=encoder, decoder=decoder, mask=None, neck=neck, uniformity_layer=uniformity_layer, 
                   alpha=args.alpha_l,
