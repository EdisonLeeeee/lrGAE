...
parser.add_argument("--encoder_activation", nargs="?", default="relu", help="Activation function for GNN encoder, (default: relu)")
...
parser.add_argument('--encoder_dropout', type=float, default=0., help='Dropout probability of encoder. (default: 0.5)')
parser.add_argument("--encoder_norm", nargs="?", default="none", help="Normalization (default: none)")

parser.add_argument('--decoder_channels', type=int, default=256, help='Channels of decoder layers. (default: 256)')
parser.add_argument('--decoder_layers', type=int, default=3, help='Number of layers for decoders. (default: 3)')
parser.add_argument('--decoder_dropout', type=float, default=0., help='Dropout probability of decoder. (default: 0.5)')
...
parser.add_argument('--undirected', action='store_true', help='Whether to perform undirected masking. (default: False)')
